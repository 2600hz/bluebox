...
class TelephonyRecordListener extends Doctrine_Record_Listener
{
    ...
    public function postUpdate(Doctrine_Event $event)
    {
        ...
        TelephonyListener::$changedModels[] = array('action' => 'update', 'record' => &$invoker, 'baseModel' => Bluebox_Record::getBaseTransactionObject());
    }
    ...
    public function postInsert(Doctrine_Event $event)
    {
        ...
        // We do this because we can't set configs until we have saved all related models that may have an auto increment!
        TelephonyListener::$changedModels[] = array('action' => 'insert', 'record' => &$invoker, 'baseModel' => Bluebox_Record::getBaseTransactionObject());
    }
    ...
    public function postDelete(Doctrine_Event $event)
    {
        ...
        // We do this because we can't set configs until we have saved all related models that may have an auto increment!
        TelephonyListener::$changedModels[] = array('action' => 'delete', 'record' => &$invoker, 'baseModel' => Bluebox_Record::getBaseTransactionObject());
    }
