...
class Package extends Bluebox_Record
{
    ...
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('version', 'float', 11, array('notnull' => true, 'notblank' => true));
        $this->hasColumn('type', 'string', 25, array('notnull' => true));
        $this->hasColumn('status', 'string', 25, array('notnull' => true, 'default' => Bluebox_PackageManager::STATUS_UNINSTALLED));
