...
(function($) {
	...
	$.extend( $.fn.jGrowl.prototype , {
		...
		render: 		function( notification ) {
			...
			var notification = $('<div class="jGrowl-notification' + ((o.group != undefined && o.group != '') ? ' ' + o.group : '') + '"><div class="close">' + o.closeTemplate + '</div><div class="growlheader">' + o.header + '</div><div class="message">' + message + '</div></div>')
