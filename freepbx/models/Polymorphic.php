 ...
 *
 * This behavior, when applied to a class that extends FreePbx_Record, results in an automatic setting of all Doctrine subclasses for
...
class Polymorphic extends Doctrine_Template {
    ...
    public function setTableDefinition()
    {
        ...
        if (get_parent_class($thisClass) == 'FreePbx_Record') {
    ...
    public function setUp()
    {
        ...
        // If this class is extending FreePbx_Class directly, then load any possibly related models and setup our subclasses
        if (get_parent_class($thisClass) == 'FreePbx_Record') {
