...
/**
 * user.php - User controller - handles user login, logout, authentication, etc.
 *
...
class User_Controller extends FreePbx_Controller {
        ...
        if ($_POST) {
            ...
            if ($post->validate()) {
                ...
                if ($token) {
                    ...
                    $from = 'noreply@store.freepbx.com';
...
<BR>
To reset your password, go to <a href="https://store.freepbx.com/store/user/password_reset">https://store.freepbx.com/store/user/password_reset</a> and follow the directions.<BR>
<BR>
