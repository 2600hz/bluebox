...
class FreePbx_Core
{
    ...
    /**
     * Check if FreePBX is running the install wizard
     * 
     * @return bool
     */
    ...
    /**
     * Provides class auto-loading for FreePbx
     *
    ...
    public static function auto_load($class)
    {
        ...
        } elseif ($suffix === 'Plugin') // Support added by Darren Schreiber - FreePBX3 project
        {
            $type = 'plugins';
