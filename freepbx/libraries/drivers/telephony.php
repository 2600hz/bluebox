...
abstract class Telephony_Driver implements Telephony_Driver_Interface {
     ...
     */
    public function network($context, FreePbx_Record $obj = NULL)
    {
     ...
     */
    public function conditioning($context, FreePbx_Record $obj = NULL)
    {
     ...
     * @param FreePbx_Record $obj
     */
    public function preRoute($context, FreePbx_Record $obj = NULL)
    {
     ...
     * @param FreePbx_Record $obj
     */
    public function postRoute($context, FreePbx_Record $obj = NULL)
    {
     ...
     * @param FreePbx_Record $obj
     */
    public function preAnswer($context, FreePbx_Record $obj = NULL)
    {
     ...
     * @param FreePbx_Record $obj
     */
    public function postAnswer($context, FreePbx_Record $obj = NULL)
    {
     ...
     * @param FreePbx_Record $obj
     */
    public function preNumber(FreePbx_Record $obj = NULL)
    {
     ...
     * @param FreePbx_Record $obj
     */
    public function postNumber(FreePbx_Record $obj = NULL)
    {
        // NOTE: $context is NULL here because pre & post number assumes the context is already set by the current macro/extension
     ...
     * @param FreePbx_Record $obj
     */
    public function postExecute($context, FreePbx_Record $obj = NULL)
    {
