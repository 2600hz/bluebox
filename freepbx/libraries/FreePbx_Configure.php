...
/**
 * FreePbx_Configure.php - Base class for module configuration classes, used in FreePBX Plugins and FreePBX Applications
 ...
 * @subpackage Core
 */
abstract class FreePbx_Configure
{
    /**
     ...
     * @var string
     */
    public static $summary = 'This is a module for FreePBX.';
    ...
    /**
     * This is a list of catagories constants as defined in FreePbx_Installer
     * @var string
     */
    public static $type = FreePbx_Installer::TYPE_DEFAULT;
    ...
    public function install($package)
    {
        ...
        if (!empty($package['models'])) {
            foreach($package['models'] as $className) {
                if ((get_parent_class($className) == 'FreePbx_Record') or (get_parent_class($className) == 'Doctrine_Record')) $models[] = $className;
            }
        }
    ...
    **********************/
     ...
     *
     * By default, FreePbx_Installer will remove any models associated with this module and then remove all files
