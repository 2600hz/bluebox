...
/**
 * FreePbx navigation class. Handles menu bar and other navigation tasks.
 *
 * @license LGPL
 * @author K Anderson
 * @package FreePBX3
...
class navigation
{
    ...
    public static function getNavTree($restrictToDepth = FALSE)
    {
        ...
        $moduleParameters = FreePbx_Core::findModulesParameters(array(
     ...
     *
     * For example the 32x32 sip interface icon for the freepbx skin would render the following
     *    search path (unless restricted to skin)
     *
     * sipinterface/assets/img/icons/32x32/freepbx/sipinterface.png
     * sipinterface/assets/img/icons/32x32/sipinterface.png
     * skins/freepbx/assets/img/icons/32x32/sipinterface.png
     * skins/freepbx/assets/img/icons/32x32/default.png
     * 
     */
    ...
    {
        $submenus = array();
        $navStructures = FreePbx_Core::getModuleParameter($module, 'navStructures');
