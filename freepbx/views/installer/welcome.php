<?php echo form::open_section('About FreePBX'); ?>
    <p>
    <?php
        echo __('FreePBX provides a modular approach to traditional telephony systems. Instead of pre-determined configuration screens and business logic, FreePBX allows you to install Applications and Plug-ins to custom tailor the system\'s behavior to your needs.');
    ?>
    </p>
