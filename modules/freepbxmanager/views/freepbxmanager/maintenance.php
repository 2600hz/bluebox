...
<div id="freepbxmanager_settings_form" class="settings freepbxmanager">
    ...
    <div class="regenerate">
        ...
        <p>Sometimes, the switch's configuration data can become out of sync with the database settings in your system. This can happen for a variety
        of reasons ranging from bugs in the software to file permission issues. You can force a regeneration of core XML files automatically.</p>
    </div>
