...
<div id="sipinterface_update_form" class="update sipinterface">
        ...
        <?php echo form::open_section('Media'); ?>
            ...
            <?php
                echo form::label(array('for' => 'sipinterface[registry][media_ip_address]',
                                       'hint' => 'Leave blank to auto-detect',
                                       'help' => 'The IP address you wish to send/receive IP traffic on, for the purposes of the media on this interface. You can define multiple SIP interfaces to allow inbound/outbound calling from multiple IPs on the same machine. On most setups, you only have one IP and can leave this blank to allow auto-detection.<BR><BR>NOTE: If you manually specify an IP address that is not actually on your system, FreeSWITCH will not bind properly to your interface and will fail to send/receive any calls on this IP! Make sure you specify an IP that actually is configured on your local system. (It can be a virtual or VLAN IP)'),
                                 'Media IP Address to Bind To:');
            ...
            <div class="field">
            <?php
                echo form::label(array('for' => 'sipinterface[registry][media_ext_ip_address]',
                                       'hint' => 'Leave blank to auto-detect',
                ...
                echo form::input('sipinterface[registry][media_ext_ip_address]');
            ?>
            </div>
    ...
    <?php else: ?>
        ...
        <?php echo form::hidden('sipinterface[registry][media_ext_ip_address]', ''); ?>

        <?php echo form::hidden('sipinterface[registry][media_ip_address]', ''); ?>

    <?php endif; ?>

    <?php echo form::open_section('NAT'); ?>
    ...
    <?php echo form::open_section('Registration'); ?>
