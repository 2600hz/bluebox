...
/**
 * VoicemailNumber.php - Number reservation model for voicemails
 *
 * This model is an alias for Numbers. It allows for numbers to be reserved for voicemails, but from the same allocation
...
class VoicemailNumber extends Number {
    ...
    public function setUp()
    {
         ...
         * Relationships
         */
        // Relate the voicemail (voicemail_id) with a generic number identifier (foreign_id) in the Number class.
        ...
        $this->hasOne('Voicemail', array('local'   => 'foreign_id',
