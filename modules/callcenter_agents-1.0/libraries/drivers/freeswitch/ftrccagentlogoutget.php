...
class FreeSwitch_ftrccagentlogoutget_Driver extends FreeSwitch_Feature_Driver
{
  ...
  <action application="set" data="res=${callcenter_config(agent set status ${agentid}@${domain_name} \'Logged Out\')}" />
