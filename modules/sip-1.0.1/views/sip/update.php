<?php echo form::open_section('SIP Settings'); ?>
    ...
    <?php if (isset($trunk_options)): ?>
        ...
        <?php
            echo form::label(array(
                    'for' => 'sip[from_user]',
                    'hint' => 'Force a user name in From: field',
                    'help' => 'Sometimes providers require explicit user names in the From: field for your calls to work (and bill) properly. This option, if set, will force a from user on all your calls in the user part of the SIP From: field'
                ),
                'SIP From Username (optional):'
            );
            echo form::input('sip[from_user]');
        ?>
        </div>
