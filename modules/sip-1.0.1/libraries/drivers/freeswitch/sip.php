    ...
    {   
        ...
        else if ($base instanceof Trunk)
        {
            ...
            if (!empty($plugins['sipinterface']['sipinterface_id']))
            {
                ...
                // Add custom from user, if set
                if (!empty($plugins['sip']['from_user'])) {
                    $xml->update('/param[@name="from-user"]{@value="' . $plugins['sip']['from_user'] . '"}');
                }
                else
                {
                    $xml->deleteNode('/param[@name="from-user"]');
                }
