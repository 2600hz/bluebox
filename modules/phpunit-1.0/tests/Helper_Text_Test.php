...
class Helper_Text_Test extends PHPUnit_Framework_TestCase
{
	...
	/**
	 * DataProvider for the text::auto_link() test
	 */
	public function auto_link_provider()
	{
		return array(
				array(
					'Visit www.example.com, and email info@example.com!',
					'Visit '.html::anchor('http://www.example.com', 'www.example.com').', and email <a href="mailto:info@example.com">info@example.com</a>'),
				array(
					'Visiting http://www.example.com, and emailing info@example.com!',
					'Visiting '.html::anchor('http://www.example.com').', and emailing <a href="mailto:info@example.com">info@example.com</a>'),
				array(
					'ftps://www.example.com/ is a secured ftp server. The username is info@example.com.',
					html::anchor('ftps://www.example.com/').' is a secured ftp server. The username is <a href="mailto:info@example.com">info@example.com</a>'),
				array(
