...
XML;
            ...
            case 'uuid_standby':
                ...
                $xmlText = <<<XML
    <action application="set" data="res=\${callcenter_config(agent set uuid \${agent_id} '\${uuid}')}" />
    <action application="set" data="res=\${callcenter_config(agent set type \${agent_id} 'uuid-standby')}" />
