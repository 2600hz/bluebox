<?php echo form::open_section('Context Information'); ?>
    ...
    <?php
        ...
        echo ' called ';
        echo form::input('context[private_name]', empty($context['private_name']) ? 'In-house Only' : $context['private_name']);
    ?>
    </div>
    ...
    <?php
        ...
        echo ' called ';
        echo form::input('context[public_name]', empty($context['public_name']) ? 'Publicly Accessible' : $context['public_name']);
    ?>
    </div>
