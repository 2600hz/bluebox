<?php echo form::open_section('SIP Device Settings'); ?>
    ...
    <div class="field">
    <?php
        echo form::label(array('for' => 'sip[username]',
    ...
    <div class="field">
    <?php
        echo form::label(array('for' => 'sip[password]',
                        ...
                        'SIP Password:');
        echo form::input('sip[password]');
        echo sipdevices::randomPwdLink('sip_password');
    ?>
    </div>

    <div class="field">
    <?php
        echo form::label(array('for' => 'sip[cid_format]',
                        ...
                        'Caller ID Format');
        echo form::dropdown('sip[cid_format]', array(
            '10 Digits', 'E.164 (+1) format'
        ));
    ?>
    </div>
    ...
    <div class="field">
    <?php
        echo form::label(array('for' => 'sip[sip_invite_format]',
                         ...
                         'SIP Invite Format');
        echo form::dropdown('sip[sip_invite_format]', array(
            '10 Digits @your.ip.address',
            'E.164 (+1) @your.ip.address',
