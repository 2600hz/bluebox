...
/**
 * ConferenceNumber.php - Number reservation model for conferences
 *
 * This model is an alias for Numbers. It allows for numbers to be reserved for conferences, but from the same allocation
