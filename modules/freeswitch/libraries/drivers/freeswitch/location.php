...
class FreeSwitch_Location_Driver extends FreeSwitch_Base_Driver {
    public static function set($obj)
    {
        ...
        $xml->update('/X-PRE-PROCESS[@cmd="set"][@freepbx="location_' . $obj->location_id . '"]{@data="location_' . $obj->location_id . '=' . $obj->domain . '"}');
    }
    ...
    public static function delete($obj)
    {
        ...
        $xml->deleteNode('/X-PRE-PROCSS[@cmd="set"][@freepbx="location_' . $obj->location_id . '"]');
    }
}
