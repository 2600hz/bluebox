...
class FreeSwitch_Odbc_Driver extends FreeSwitch_Base_Driver {
    public static function set($obj)
    {
        ...
        $xml->update('/X-PRE-PROCESS[@cmd="set"][@freepbx="odbc_' . $obj->odbc_id . '"]{@data="odbc_' . $obj->odbc_id . '=' . $dsn . '"}');
    }
    ...
    public static function delete($obj)
    {
		...
		$xml = Telephony::getDriver()->xml;
        $xml->setXmlRoot('//document/section[@name="odbc"]/X-PRE-PROCESS[@cmd="set"][@freepbx="odbc_' . $obj->odbc_id . '"]');
        $xml->deleteNode();
    }
}
