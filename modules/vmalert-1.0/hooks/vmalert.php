...
// or perform it's own save actions.
    ...
    plugins::register('voicemail/edit', 'view', array('VMAlert_Plugin', 'update'));
    plugins::register('voicemail/create', 'view', array('VMAlert_Plugin', 'update'));
    plugins::register('voicemail', 'save', array('VMAlert_Plugin', 'save'));
