...
class FreeSwitch_MyPlugin_Driver
{
     ...
     */
    public static function set($myPluginData)
    {
        ...
        $prefix = sprintf('/feature[@name="%s"]', $myPluginData['mydatafield1']);
        ...
        $xml->update($prefix . '/variables/variable[@name="mydatafield2"]{@value="' .$myPluginData['mydatafield2'] . '"}');
    }
