...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php jquery::addPlugin(array('persistent', 'scrollTo', 'growl', 'qtip', 'infiniteCarousel', 'dropdowns', 'blockUI')); ?>
        <?php javascript::add('freepbx'); ?>

        <?php echo $css ?>
        <?php echo $js ?>

        <?php echo html::link('skins/freepbx/assets/img/favicon.ico', 'icon', 'image/x-icon'); ?>
    </head>
